...
Feature tracking and test various detector / descriptor combinations. This project consists of four parts:

* Load images into a ring buffer to optimize memory load. 
